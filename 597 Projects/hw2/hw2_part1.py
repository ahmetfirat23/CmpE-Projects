...
if __name__ == "__main__":
    # call lstm
    lstm_ae = LSTMAutoencoder(hidden_dim=128, num_layers=2, latent_dim=32)
    lstm_ae, history_lstm = train_autoencoder(lstm_ae, train_loader, val_loader, num_epochs=25)
    ...
    conv_ae, history_conv = train_autoencoder(conv_ae, train_loader, val_loader, num_epochs=25)
    plot_loss(history_conv, "CNN Autoencoder MSE")
    tsne_plot(conv_ae, all_ds, title="CNN Autoencoder")
