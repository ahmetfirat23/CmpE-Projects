...
state(0, agent_dict{0: agent{x: 1, y: 1, class: warrior, health: 100, mana: 100, agility: 2, armor: 8, name: 'Arthur'},
                    1: agent{x: 9, y: 9, class: wizard, health: 100, mana: 100, agility: 5, armor: 2, name: 'Merlin'},
...
state(1, agent_dict{0: agent{x: 1, y: 2, class: warrior, health: 100, mana: 100, agility: 2, armor: 8, name: 'Arthur'},
                    1: agent{x: 9, y: 9, class: wizard, health: 100, mana: 100, agility: 5, armor: 2, name: 'Merlin'},
                    2: agent{x: 5, y: 5, class: rogue, health: 100, mana: 100, agility: 8, armor: 5, name: 'Mordred'}}, 1, [0, 1, 2]).
state(2, agent_dict{0: agent{x: 1, y: 2, class: warrior, health: 100, mana: 100, agility: 2, armor: 8, name: 'Arthur'},
                    1: agent{x: 8, y: 9, class: wizard, health: 100, mana: 100, agility: 5, armor: 2, name: 'Merlin'},
                    2: agent{x: 5, y: 5, class: rogue, health: 100, mana: 100, agility: 8, armor: 5, name: 'Mordred'}}, 2, [0, 1, 2]).
